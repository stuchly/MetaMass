...
###################################################
### code chunk number 16: MetaMass.rnw:355-359
###################################################
file2<-system.file("extdata","Data_Fig_1b.txt",package="MetaMass")
...
###################################################
### code chunk number 17: MetaMass.rnw:369-373
###################################################
...
###################################################
### code chunk number 20: produce-plot
###################################################
pdf('roc1.pdf')
par(mfrow=c(3,3),mar=c(1, 4, 2.2, 1) + 0.1,cex=0.45)
...
###################################################
### code chunk number 21: MetaMass.rnw:427-429
###################################################
...
###################################################
### code chunk number 22: MetaMass.rnw:435-437
###################################################
files2<-system.file("extdata",c("Bileck.txt","Thakar.txt","Carvalho.txt","Andreyev.txt","Rodriguez.txt"),package="MetaMass")
...
###################################################
### code chunk number 23: MetaMass.rnw:443-445
###################################################
files2<-system.file("extdata",c("Bileck.txt","Thakar.txt","Carvalho.txt","Andreyev.txt","Rodriguez.txt"),package="MetaMass")
...
###################################################
### code chunk number 24: produce-plot
###################################################
pdf('roc2.pdf')
par(mfrow=c(3,3),mar=c(1, 4, 2.2, 1) + 0.1,cex=0.45)
